...
export const Dashboard: React.FC<DashboardProps> = ({ products, sales, isDarkMode }) => {
  ...
  const StatCard = ({ title, value, icon: Icon, colorClass, subtext }: any) => (
    <div className="bg-brand-surface p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-800 flex items-start justify-between transition-all hover:scale-[1.02] duration-300">
      <div>
