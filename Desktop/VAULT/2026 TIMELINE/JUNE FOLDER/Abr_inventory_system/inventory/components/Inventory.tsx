                ...
                <div className="p-6 space-y-5 flex-1 overflow-y-auto custom-scrollbar">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2">
                      ...
                      <input required type="text" className="w-full px-3 py-3 border border-gray-700 bg-white dark:bg-gray-700 text-brand-text rounded-xl focus:ring-2 focus:ring-brand-gold/20 focus:border-brand-gold outline-none transition-all" value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} />
                    </div>
                    <div className="col-span-2 sm:col-span-1">
                       <label className="block text-sm font-medium text-brand-text/80 mb-1">SKU</label>
                       <div className="flex gap-2">
                         <input required type="text" className="w-full px-3 py-3 border border-gray-700 bg-white dark:bg-gray-700 text-brand-text rounded-xl outline-none" value={formData.sku} onChange={e => setFormData({...formData, sku: e.target.value})} />
                         <button type="button" onClick={() => { setIsModalOpen(false); openBarcodeScanner('sku'); }} className="p-3 bg-gray-100 dark:bg-gray-700 text-brand-text/70 rounded-xl">
                           <Barcode size={20} />
                         </button>
                       </div>
                    </div>
                    <div className="col-span-2 sm:col-span-1">
                      ...
                      <input required type="text" className="w-full px-3 py-3 border border-gray-700 bg-white dark:bg-gray-700 text-brand-text rounded-xl outline-none" value={formData.category} onChange={e => setFormData({...formData, category: e.target.value})} />
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-xl border border-gray-800 space-y-4">
                     ...
                     <div className="grid grid-cols-2 gap-4">
                        <div className="col-span-2 sm:col-span-1 relative">
                           ...
                           <input type="number" className="w-full px-3 py-3 border border-gray-700 bg-white dark:bg-gray-700 text-brand-text rounded-xl outline-none" value={formData.vendorPrice} onChange={e => setFormData({...formData, vendorPrice: parseFloat(e.target.value)})} placeholder="0.00" />
                        ...
                        <div className="col-span-2 sm:col-span-1">
                          ...
                          <input required type="number" className="w-full px-3 py-3 border border-gray-700 bg-white dark:bg-gray-700 text-brand-text rounded-xl outline-none" value={formData.price} onChange={e => setFormData({...formData, price: parseFloat(e.target.value)})} placeholder="0.00" />
                        </div>
                     </div>
                     ...
                     <div className="grid grid-cols-2 gap-4 pt-2 border-t border-dashed border-gray-700">
                        <div className="col-span-2 sm:col-span-1">
                           ...
                           <input type="number" className="w-full px-3 py-3 border border-gray-700 bg-white dark:bg-gray-700 text-brand-text rounded-xl outline-none" value={formData.pricePerPack} onChange={e => setFormData({...formData, pricePerPack: parseFloat(e.target.value)})} placeholder="0.00" />
                        </div>
                        <div className="col-span-2 sm:col-span-1">
                           <label className="block text-sm font-medium text-brand-text/80 mb-1">Items in Pack</label>
                           <input type="number" min="1" className="w-full px-3 py-3 border border-gray-700 bg-white dark:bg-gray-700 text-brand-text rounded-xl outline-none" value={formData.quantityPerPack} onChange={e => setFormData({...formData, quantityPerPack: parseInt(e.target.value) || 1})} />
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                     <div className="col-span-1">
                      ...
                      <input required type="number" className="w-full px-3 py-3 border border-gray-700 bg-white dark:bg-gray-700 text-brand-text rounded-xl outline-none" value={formData.stock} onChange={e => setFormData({...formData, stock: parseInt(e.target.value)})} />
                    </div>
                     <div className="col-span-2 flex gap-4">
                      <div className="flex-1">
                        <label className="block text-sm font-medium text-brand-text/80 mb-1">Low Stock Threshold</label>
                        <input required type="number" className="w-full px-3 py-3 border border-gray-700 bg-white dark:bg-gray-700 text-brand-text rounded-xl outline-none" value={formData.lowStockThreshold} onChange={e => setFormData({...formData, lowStockThreshold: parseInt(e.target.value)})} />
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                     <div className="col-span-2">
                      ...
                      <input type="text" className="w-full px-3 py-3 border border-gray-700 bg-white dark:bg-gray-700 text-brand-text rounded-xl outline-none" value={formData.supplier} onChange={e => setFormData({...formData, supplier: e.target.value})} />
                    </div>
                     <div className="col-span-2">
                      <label className="block text-sm font-medium text-brand-text/80 mb-1">Description</label>
                      <textarea rows={3} className="w-full px-3 py-3 border border-gray-700 bg-white dark:bg-gray-700 text-brand-text rounded-xl outline-none resize-none" value={formData.description || ''} onChange={e => setFormData({...formData, description: e.target.value})} placeholder="Optional details..." />
                    </div>
                  </div>
                </div>
